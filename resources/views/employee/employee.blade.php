                            ...
                            <div class="form-row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="staff_id" id="staff_group" class="form-control">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="designation_id" id="designation_list" class="form-control">
...
<script>
    ...
    $(document).ready(
        ...
        () => {
            $("#staff_group").change(
                () => {
                    var id = $("#staff_group option:selected").val();
                    console.log(id);
                    var designationList = $("#designation_list");
                    ...
                    $.ajax(
                        {
                            type: 'GET',
                            url:'/staff-groups/'+id+'/getDesignations/',
                            dataType: 'json',
                            success: function(designations){
                                ...
                                $.each(designations , function ( i , designation){
                                    designationList.append("<option value="+designation.id+">"+designation.title+"</option>");
                                });
                            }
                        }
                    )
